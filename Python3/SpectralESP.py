""" Orig Author: 	HWReverse Twitter: 	@r0_hw aka HWR0
GitHub:		https://github.com/hwreverse/

8/29/2020 Edited for MacOS and ported to Python3
          Scrapes readings from ESP32 wireless connected AS7265x sensor
          Dropped all serial port interface code
"""
...
while (loop):
	...
	spectreData = requests.get('http://192.168.1.32',stream=True)
	spectreDataStr = spectreData.text
	spectreDataStr = spectreDataStr.strip("()")
	spectreList = spectreDataStr.split(",")
